...
dependencies {
    ...
    implementation("org.springframework.boot:spring-boot-starter-security:3.5.16")
    implementation("org.springframework.boot:spring-boot-starter-thymeleaf:3.5.16")
